...
with open("../Day 20 (email merge project)/Input/Names/invited_names.txt", "r") as name_file:
    names = name_file.readlines()


with open("../Day 20 (email merge project)/Input/Letters/starting_letter.txt") as letter_file:
